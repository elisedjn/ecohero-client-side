...
function ExperienceBar(props) {
    ...
    if (props.loggedInUser.points >= 10000 && props.loggedInUser.points < 25000) {
        ...
        let percentage = Math.ceil((props.loggedInUser.points - superHero.points)/(bigHero.points - superHero.points) *100)
        return (
            <div>
                <div className="ranksContainer">
                    <p className="ranks">{bigHero.title}</p> 
        ...
        let percentage = Math.ceil((props.loggedInUser.points - chillHero.points)/(chillHero) *100)
        return (
            <div>
                <div className="ranksContainer">
